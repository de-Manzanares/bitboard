...
//----------------------------------------------------------------------------------------------------------------------
// Create a list of all possible moves for a given piece.
///---------------------------------------------------------------------------------------------------------------------
/// @brief Create a list of all possible moves for a given piece.
///
/// Uses `calculateMovesDiagonal()`, `calculateMovesHorizontal()`, and `calculateMovesVertical()` to populate vector
/// `range` with all possible moves for the given piece.
///
/// @post vector `range` is populated with all possible moves for the given piece.
///
/// @param pieceFrom    The piece to move.
/// @param indexFrom    The index of the piece to move.
/// @param range        The vector to populate with all possible moves for the given piece.
