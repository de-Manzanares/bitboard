...
bool isInFile(char file, int index)
{
    ...
    switch (file) {
    case 'A':indicesInFile = {7, 15, 23, 31, 39, 47, 55, 63};
        break;
    case 'B':indicesInFile = {6, 14, 22, 30, 38, 46, 54, 62};
        break;
    case 'C':indicesInFile = {5, 13, 21, 29, 37, 45, 53, 61};
        break;
    case 'D':indicesInFile = {4, 12, 20, 28, 36, 44, 52, 60};
        break;
    case 'E':indicesInFile = {3, 11, 19, 27, 35, 43, 51, 59};
        break;
    case 'F':indicesInFile = {2, 10, 18, 26, 34, 42, 50, 58};
        break;
    case 'G':indicesInFile = {1, 9, 17, 25, 33, 41, 49, 57};
        break;
    case 'H':indicesInFile = {0, 8, 16, 24, 32, 40, 48, 56};
        break;
